...
type FakeHTTPChecks struct {
	Fake *FakePingdomV1alpha1
	ns   string
}

var httpchecksResource = schema.GroupVersionResource{Group: "pingdom.mallon.io", Version: "v1alpha1", Resource: "httpchecks"}

var httpchecksKind = schema.GroupVersionKind{Group: "pingdom.mallon.io", Version: "v1alpha1", Kind: "HTTPCheck"}
